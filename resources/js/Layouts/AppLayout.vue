            ...
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('test1')" :active="route().current('test1')">
                            Test 1
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('test2')" :active="route().current('test2')">
                            Otro Test 2
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink :href="route('deliveries.index')" :active="route().current('deliveries.index')">
                                    Deliveries
                        </ResponsiveNavLink>
